...
Arena::Arena(int nRows, int nCols)
	: m_history(nRows, nCols)          // use initializer list to construct history object
{
...
History& Arena::history()                             // accessor to history reference
{
	return m_history;                 // returns the history object
}
