...
{
    m_age++;
	m_arena->history().record(m_row, m_col);       // have player use record function to incrememnt number of times playyer has stepped on coordinate for a stand
}
...
void Player::move(int dir)
{
	...
	m_arena->history().record(m_row, m_col);       // have player use record function to incrememnt number of times playyer has stepped on coordinate for a move
}
